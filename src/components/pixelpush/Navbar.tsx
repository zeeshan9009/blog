...
export const Navbar: React.FC = () => {
  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-40 bg-white/85 backdrop-blur-xl border-b border-slate-200/80 shadow-modern-sm transition-all">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-8">
          <div className="h-16 flex items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-8 lg:gap-10 shrink-0">
              ...
              {/* Main Nav Links */}
              <nav className="hidden md:flex items-center gap-1 text-xs font-semibold text-slate-600" aria-label="Main Navigation">
                ...
                <button
                  ...
                  className="hover:text-[#e8622c] hover:bg-orange-50/70 transition px-3 py-2 rounded-lg flex items-center gap-1.5 text-[#e8622c] font-bold cursor-pointer"
                >
                ...
                <button
                  ...
                  className="hover:text-amber-900 hover:bg-amber-50/70 transition px-3 py-2 rounded-lg flex items-center gap-1.5 text-slate-800 font-bold cursor-pointer"
                >
                ...
                <button
                  ...
                  className="hover:text-slate-950 hover:bg-slate-100 transition px-3 py-2 rounded-lg cursor-pointer"
                >
                  About
                </button>
                ...
                <a
                  ...
                  className="hover:text-slate-950 hover:bg-slate-100 transition px-3 py-2 rounded-lg"
                >
                  How It Works
                </a>
              </nav>
              ...
              {user ? (
                <div className="relative" ref={userMenuRef}>
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-1.5 bg-slate-50 hover:bg-slate-100 border border-slate-200/90 rounded-xl text-xs font-bold text-slate-800 transition shadow-xs cursor-pointer"
                  >
                    {user.avatar_url ? (
                      <img
                        src={user.avatar_url}
                  ...
                  {userDropdownOpen && (
                    <div className="absolute right-0 top-full mt-2 w-52 bg-white border border-slate-200/90 rounded-2xl shadow-modern-lg p-2 z-50 animate-fadeIn">
                      <Link
                        to="/dashboard"
                        onClick={() => setUserDropdownOpen(false)}
                        className="flex items-center gap-2 px-3 py-2 text-xs font-semibold text-slate-700 hover:text-slate-950 hover:bg-slate-50 rounded-lg transition"
                      >
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-2 px-3 py-2 text-xs font-semibold text-slate-700 hover:text-slate-950 hover:bg-slate-50 rounded-lg transition text-left cursor-pointer"
                      >
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-2 px-3 py-2 text-xs font-semibold text-red-600 hover:bg-red-50 rounded-lg transition text-left cursor-pointer pt-2 border-t border-slate-100"
                      >
                ...
                <div className="flex items-center gap-2.5">
                  <button
                    ...
                    className="px-5 py-2 bg-slate-900 hover:bg-[#e8622c] text-white font-sans text-xs font-bold rounded-xl transition-all shadow-sm cursor-pointer"
                  >
                    Sign in
                  </button>
                </div>
